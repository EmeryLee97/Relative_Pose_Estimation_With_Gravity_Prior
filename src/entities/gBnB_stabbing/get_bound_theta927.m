function [upper_bound, lower_bound, theta] = get_bound_theta927( ...
    ...
    angle_a_t = angle_a_tc + gamma_set{i}(1, :)'; % (m, n) 
    angle_b_t = angle_b_tc + gamma_set{i}(2, :)'; % (m, n) 
    angle_c_t = angle_c_tc + gamma_set{i}(3, :)'; % (m, n) 
