function [t_opt_3d, theta_opt, iter] = solve_BnB_sampling_itertimes(N, pts_1, pts_2, R_v, epsilon)
% pts_1: matching points in the 1st image
% pts_2: matching points in the 2nd image
% g1: Gravity direction of the 1st image plane, 3*1 vector
% g2: Gravity direction of the 2nd image plane, 3*1 vector
